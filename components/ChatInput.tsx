...
export const ChatInput: React.FC<ChatInputProps> = ({
    ...
    const disabled = isBotTyping || isDisabled;
        ...
        <>
            ...
            >
                ...
                <textarea
                    ...
                    className="w-full border-none focus:ring-0 focus:outline-none resize-none bg-transparent py-3 text-base placeholder-ink-500 text-ink-900 disabled:cursor-not-allowed"
