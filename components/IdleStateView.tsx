 ...
 * Surfaces the legal documents that a commercial service has to expose,
 * without weighing down the hero. Shown on the landing page and on
 * full-screen auxiliary pages (Profile, 404) via direct import.
 */
